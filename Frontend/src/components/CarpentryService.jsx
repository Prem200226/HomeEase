    ...
    return (
        <Container className="my-4">
            ...
            <p className="mb-5 text-center text-muted" style={{ maxWidth: 600, margin: '0 auto' }}>
                Explore our top-rated Carpentry repair and installation services. Book a professional for all your Carpentry needs, from appliance repair to wiring and more.
            </p>
            {isLoading ? (
